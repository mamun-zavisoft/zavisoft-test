            ...
            <div class="container">
                <div
                    ...
                    <div class="flex flex-col items-center gap-2 md:gap-3 lg:gap-4 justify-center ">
                        <h1
                            class=" text-center text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl leading-10 lg:leading-16  font-bold text-neutral-900">
                            Featured Insights: Top Blog <br> <span class="text-neutral-500 text-center">Highlights &
                                Beyond</span>
                        </h1>
                        <p class="text-sm md:text-base text-neutral-600">Dreaming of a job where you can build cool
                ...
                <div class="recent-blogs mt-10">
                    ...
                    <div class="mt-6 flex justify-center">
                        <button
                            class="lg:text-base text-sm px-4 lg:px-6 py-2 lg:py-3 bg-primary-600 text-white rounded-lg hover:bg-primary-700 transition duration-300">
                            Load More
                        </button>
                    </div>
...
const blogs = [
    {
        ...
        title: "Game Changer Alert: Canva Code is Here Transforms Ideas into Reality"
    },
    {
        id: 2,
        writer: "Richard Aurora",
