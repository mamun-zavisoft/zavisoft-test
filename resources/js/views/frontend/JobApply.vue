                ...
                <form action="#" method="post" class="space-y-5 bg-neutral-50 rounded-2xl p-6">
                    ...
                    <div class="grid grid-cols-1">
                        <div class="flex flex-col gap-2">
                            ...
                            <input id="github" name="gitlink" type="text" placeholder="Type here"
                                class="placeholder:text-[13px] h-10 rounded-full border border-transparent bg-white px-3 text-sm text-neutral-900 outline-none ring-0 focus:border-primary-500" />
                        </div>
                    </div>
                    <div class="grid grid-cols-1">
                        <div class="flex flex-col gap-2">
                            <label for="socialprofile" class="text-sm font-medium text-neutral-600">Linkedin
                                link</label>
                            <input id="socialprofile" name="socialprofile" type="text" placeholder="Type here"
                                class="placeholder:text-[13px] h-10 rounded-full border border-transparent bg-white px-3 text-sm text-neutral-900 outline-none ring-0 focus:border-primary-500" />
                        </div>
                    </div>
                        ...
                        <div class="flex items-center justify-center w-full">
                            <label for="dropzone-file"
                                ...
                                <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                    ...
                                    <p class="text-xs text-neutral-500 ">SVG, PNG, JPG or GIF (MAX.
                                        800x400px)</p>
                                </div>
