                    ...
                    <div class="grid grid-cols-12 gap-6 sm:gap-8 ">
                        ...
                        <div class="col-span-12 sm:col-span-7 md:col-span-5 lg:col-span-3">
                            ...
                            <ul class="space-y-3 text-[13px] text-white lg:text-sm font-[300]">
                                ...
                                <li><a href="#" class="hover:text-white">Mobile App Developement</a></li>
                                <li><a href="#" class="hover:text-white">Web Application Development</a></li>
                                <li><a href="#" class="hover:text-white">QA Testing</a></li>
                                <li><a href="#" class="hover:text-white">Database Management</a></li>
                            </ul>
                        </div>
