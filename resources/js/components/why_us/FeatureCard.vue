<template>
    ...
    <!-- Mobile Slider -->
    <div class="sm:hidden">
        <Swiper class="feature-slider px-4" :modules="[Autoplay, Pagination]" :slides-per-view="1" :space-between="24"
...
:deep(.feature-slider .swiper-pagination-bullet) {
    width: 8px;
    height: 8px;
...
:deep(.feature-slider .swiper-pagination-bullet-active) {
    width: 26px;
