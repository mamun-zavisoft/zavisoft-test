                ...
                <div class="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
                    ...
                    <div class="hidden md:flex items-center gap-6">
                        ...
                        <fwb-dropdown>
                            ...
                            <nav class="py-2 text-sm text-gray-700 dark:text-gray-200" role="menu">
                                <a href="#"
        ...
        <footer class="container mx-auto ">
            <div class="px-4 py-12">
                <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 sm:gap-8">
                    ...
                    <div class="col-span-2 sm:col-span-2 space-y-4">
...
const filteredNavigation = computed(() => {
    return allNavigation.filter(link => {
        if (link.showAlways) return true;
        if (link.showWhen === 'authenticated' && auth.isAuthenticated) {
            // Check if the link has a role requirement
            if (link.requiredRole) {
                return auth.role === link.requiredRole;
            }
            return true;
        }
        if (link.showWhen === 'unauthenticated' && !auth.isAuthenticated) {
            return true;
        }
        return false;
    });
