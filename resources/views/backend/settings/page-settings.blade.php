                    ...
                    <div class="md:flex">
                        <ul id="home-page-tab" data-tabs-toggle="#home-page-tab" role="tablist"
                            ...
                            <li class="me-2" role="presentation">
                                <button
                                    class="tab-btn inline-block hover:text-neutral-600 hover:border-neutral-300 dark:hover:text-neutral-300"
                                    id="home-industry-focus-tab" data-tabs-target="#home-industry-focus" type="button"
                                    role="tab" aria-controls="home-industry-focus" aria-selected="false">Industry
                                    Focus</button>
                            </li>
                        ...
                        <div id="about-page-tab" class="page-tab-content">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-x-5 gap-y-0 ">
                                        <div>
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="" placeholder="Write Heading One" />
                                            </div>
                                        </div>
                                        <div>
                                            <div class="form-group">
                                                <label>Heading Two <span class="manitory">*</span></label>
                                                <input type="text" name="" placeholder="Write Heading Two" />
                                            </div>
                                        </div>
                                        <div>
                                            <div class="form-group">
                                                <label>Short Description One <span class="manitory">*</span></label>
                                                <textarea name="" id="" cols="30" rows="10" type="text"
                                        ...
                                        <div class="col-span-1 md:col-span-2">
                                            <div class="form-group">
                                                <label class="text-base text-red-800"> Company Logo (width : 140 x height :
                                                    40)</label>
                                                <div class="image-upload">
                                                    <input type="file">
                                                    <div class="image-uploads flex flex-col items-center justify-center">
                            ...
                            <div class="hidden" id="about-slider" role="tabpanel" aria-labelledby="about-slider-tab">
                                <form action="">
                                    <div class="grid grid-cols-1 ">
                                        <div class="form-group">
                                            <label class="text-base text-red-800"> Slider Image (width : 240 x height :
                                                240)</label>
                                            <div class="image-upload">
                                                <input type="file">
                                                <div class="image-uploads flex flex-col items-center justify-center">
