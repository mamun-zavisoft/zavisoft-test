...
$(document).ready(function () {
	...
	var right_side_views = '<div class="right-side-views d-none">' +
		...
		'<img src="assets/images/icons/siderbar-icon2.svg" class="feather-five" alt="">' +
		...
		'<img src="assets/images/logo.png" alt="Logo" class="img-flex">' +
		'</a>' +
		'</div>' +
		'</div>' +
		'<div class="col-xl-6 col-sm-6 col-12">' +
		'<a class="btn-closed" href="javascript:void(0);"><img class="img-fliud" src="assets/images/icons/sidebar-delete-icon.svg" alt="demo"></a>' +
		'</div>' +
		'</div>' +
		'</div>' +
		'</div>' +
		...
		'<img class="img-fliud" src="assets/images/demo-one.png" alt="demo">' +
		'</div>' +
		'<div class="row">' +
	...
	if (false) {
		var customize_link = '<div class="customizer-links d-none">' +
			...
			'<a class="sidebar-close" href="#"><img src="assets/images/icons/close-icon.svg" alt=""></a>' +
			'</div>' +
			'<div class="sidebar-body">' +
			'<h6 class="theme-title">Choose Mode</h6>' +
			'<div class="switch-wrapper">' +
			'<div id="dark-mode-toggle">' +
			'<span class="light-mode active"> <img src="assets/images/icons/sun-icon.svg" class="mr-2" alt=""> Light</span>' +
			...
			'<img class="img-fliud" src="assets/images/layout-ltr.png" alt="layout">' +
			'</div>' +
			'</div>' +
			'</div>' +
			'<div class="ere">' +
			...
			'</div>' +
			'<div class="layout-img">' +
			'<img class="img-fliud" src="assets/images/layout-rtl.png" alt="layout">' +
			'</div>' +
			'</div>' +
			'</div>' +
			'</div>' +
			...
			'</div>' +
			'<div class="layout-img">' +
			'<img class="img-fliud" src="assets/images/layout-04.png" alt="layout">' +
			'</div>' +
			'</div>' +
			'</div>' +
			'<div class="ere">' +
			...
			'</div>' +
			'<div class="layout-img">' +
			'<img class="img-fliud" src="assets/images/layout-01.png" alt="layout">' +
			'</div>' +
			'</div>' +
			'</div>' +
			'</div>' +
			...
			'</div>' +
			'<div class="layout-img">' +
			'<img class="img-fliud" src="assets/images/layout-03.png" alt="layout">' +
			'</div>' +
			'</div>' +
			'</div>' +
			'<div class="ere">' +
